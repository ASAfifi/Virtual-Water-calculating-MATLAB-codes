...
%% Load the data
AllCountries = readtable('Seasons_VWTOTAL_AllCountries_VWprod_VW_Normalized.xlsx', 'VariableNamingRule', 'preserve');
...
writetable(AllCountriesFinal, 'Seasons_VWTOTAL_Final_Annual_All_Countries_CostImpExp.xlsx');